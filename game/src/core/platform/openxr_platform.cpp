...
OpenXRPlatform::OpenXRPlatform(GraphicsAPI_Type apiType) : m_apiType(apiType)
{
...
void OpenXRPlatform::get_enviroment_blend_modes()
{
...
void OpenXRPlatform::render_frame()
{
	QUE_PROFILE;
...
void OpenXRPlatform::get_system()
{
