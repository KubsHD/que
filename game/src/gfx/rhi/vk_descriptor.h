...
struct DescriptorLayoutBuilder {
	...
	void add_binding_array(uint32_t binding, VkDescriptorType type, uint32_t count);
	void clear();
...
struct DescriptorWriter {
	...
	void write_image_array(int binding, std::vector<VkImageView> ivs, VkSampler sampler, VkImageLayout layout, VkDescriptorType);
